...
const Banner = () => {
  return (
    <div className=" p-10 lg:p-20 mt-10 relative">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="flex justify-end px-20 relative">
          <div className="mt-10">
            ...
            <div className=" absolute top-24 left-0 z-20">
              <div className="card card-side bg-base-100 shadow-xl px-5">
                ...
                <div className="card-body">
                  <h5 className="text-[16px] font-bold">150+</h5>
            ...
            />
            <Image
              className="absolute top-[297px] z-0 right-[30px]"
              src="/Vector 32.png"
              alt=".."
              priority
              title="..."
            ...
            />
            {/* traing  */}
            <span className="absolute z-20 right-0 bottom-0">
              <div className="card w-[187px] bg-base-100 shadow-xl">
                <figure className="px-10 pt-5 ">
                  <FcBusinessman className="text-white bg-primary rounded-full w-[66px] h-[66px]" />
                </figure>
                <div className="py-5 text-center ">
                  <h2 className=" text-[16px]">Zaqky Simorang</h2>
